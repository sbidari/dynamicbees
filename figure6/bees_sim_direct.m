...
function [u1_plus,u2_plus,u1_minus,u2_minus] = bees_sim_direct(T,alpha,params)
% Direct Switch
...
dxdt = zeros(2,1);
dxdt(1) = (params.Aa + params.B*x(1))*(1- x(1) - x(2)) - x(1)*params.G - params.P*(params.lagB-params.lagA)*x(1)*x(2);
dxdt(2) = (params.Ab + params.B*x(2))*(1- x(1) - x(2)) - x(2)*params.G - params.P*(params.lagA-params.lagB)*x(1)*x(2);
end
