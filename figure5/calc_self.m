function [J] = calc_self(x,alpha,T)
%Self inhibition model for two foraging sites
% x
...
dxdt(1) = (params.Aa + params.B*x(1))*( 1- x(1) - x(2) ) - x(1)*params.G - params.P*(alpha-params.lagA)*x(1)^2;
dxdt(2) = (params.Ab + params.B*x(2))*( 1- x(1) - x(2) ) - x(2)*params.G - params.P*(alpha-params.lagB)*x(2)^2;
end
